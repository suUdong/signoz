...
func incidentTemplateData(labels map[string]string, annotations map[string]string) map[string]string {
	incident := map[string]string{
		...
		"ai_strategy_id":     annotations[alertmanagertypes.IncidentAnnotationAIStrategyID],
		"ai_strategy_status": annotations[alertmanagertypes.IncidentAnnotationAIStrategyStatus],
		"ai_headline":        annotations[alertmanagertypes.IncidentAnnotationAIHeadline],
		"ai_first_actions":   annotations[alertmanagertypes.IncidentAnnotationAIFirstActions],
		"ai_confidence":      annotations[alertmanagertypes.IncidentAnnotationAIConfidence],
		"ai_limitations":     annotations[alertmanagertypes.IncidentAnnotationAILimitations],
		"ai_evidence_refs":   annotations[alertmanagertypes.IncidentAnnotationAIEvidenceRefs],
	}
